...
def main():
    ...
    for subtask_name in subtask_name_list:
        ...
        if os.path.exists(pred_file):
            ...
            if 'Subtask_1' in subtask_name and False:
...
if __name__ == "__main__":
    # main()
    GOLD_EVAL_FILE_PATH = "/tmp/semeval24_task3/SemEval-2024_Task3/official_data/Training_data/text/testing.json"
    PREDICTION_FILE_PATH = "/home2/suyash.mathur/semeval24/task3/BiLSTM+CRF/Subtask_2_pred.json"
    
    with open(GOLD_EVAL_FILE_PATH, "r") as f:
